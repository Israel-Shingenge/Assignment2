...
public isolated function addShipmentDetails( Shipment ship) returns int|error {
    sql:ExecutionResult result = check dbClient->execute(`
        INSERT INTO Shipment (customer_id,shipment_id shipmentType, pickupLocation, deliveryLocation, preferedTimeSlot, trackingNumber)
        VALUES (${ship.customer_id}, ${ship.shipment_id},${ship.shipmentType}, ${ship.pickupLocation}, 
